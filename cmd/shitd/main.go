...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:               "shitd",
		Short:             "shithole App Daemon (server)",
...
func exportAppStateAndTMValidators(
	...
	if height != -1 {
		shitApp := app.NewShitApp(logger, db)
		err := shitApp.LoadHeight(height)
		if err != nil {
			return nil, nil, err
		}
	...
	return shitApp.ExportAppStateAndValidators(forZeroHeight, jailWhiteList)
}
