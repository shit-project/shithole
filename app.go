...
// NewShitApp is a constructor function for shitApp
func NewShitApp(logger log.Logger, db dbm.DB) *shitApp {
	...
	app.mm = module.NewManager(
		...
		shit.NewAppModule(app.shitKeeper, app.bankKeeper),
...
func (app *shitApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
